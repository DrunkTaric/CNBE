...
<template>
  <svg v-if="colorMode.value == 'light'" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="SVGRepo_iconCarrier">
      <g>
        <circle fill="#231F20" cx="32" cy="14" r="3"></circle>
        <path fill="#231F20"
        ...
        <path fill="#231F20" d="M4,58h56c0-2.209-1.791-4-4-4H8C5.791,54,4,55.791,4,58z"></path>
        <path fill="#231F20" d="M63.445,60H0.555C0.211,60.591,0,61.268,0,62v2h64v-2C64,61.268,63.789,60.591,63.445,60z">
        </path>
      </g>
    </g>
  </svg>
  <svg v-if="colorMode.value == 'dark'" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" enable-background="new 0 0 64 64"
